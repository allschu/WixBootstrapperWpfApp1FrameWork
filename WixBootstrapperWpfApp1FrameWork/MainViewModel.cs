...
[assembly: mba.BootstrapperApplicationFactory(typeof(WixToolset.WixBA.WixBAFactory))]

namespace WixToolset.WixBA
{
    public class WixBAFactory : mba.BaseBootstrapperApplicationFactory
    {
...
public class MainViewModel : INotifyPropertyChanged
{
    ...
    private RegistrationType detecteRegistrationType = RegistrationType.None;
    ...
    private void OnError(object sender, mba.ErrorEventArgs e)
    {
    ...
    /// </summary>
    private void OnApplyComplete(object sender, mba.ApplyCompleteEventArgs e)
    {
        IsBusy = false;
        InstallEnabled = false;
        UninstallEnabled = false;
    ...
    /// </summary>
    private void OnDetectPackageComplete(object sender, mba.DetectPackageCompleteEventArgs e)
    {
        // Debug.Assert(false);
    ...
    /// </summary>
    private void OnPlanComplete(object sender, mba.PlanCompleteEventArgs e)
    {
        if (e.Status >= 0)
